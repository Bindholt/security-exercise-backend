...
public class SecurityConfig {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http, HandlerMappingIntrospector introspector) throws Exception {
    ...
    http.authorizeHttpRequests((authorize) -> authorize
            ...
            .requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.PUT, "/recipes/*")).hasAnyAuthority("ADMIN", "USER")
            .requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.DELETE, "/recipes/*")).hasAnyAuthority("ADMIN", "USER")
            .requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.POST, "/recipes")).hasAnyAuthority("ADMIN", "USER")
